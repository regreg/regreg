...
def test_l1prox():
    ...
    np.testing.assert_allclose(ac, ab, rtol=1.e-4)
    np.testing.assert_allclose(ac, ad, rtol=1.e-4)
...
def test_lasso():
    ...
    np.testing.assert_allclose(ans, solver2.composite.coefs, rtol=1.e-4)
